                ...
                <div class="card-body">               
                    ...
                    <form method="POST" action="{{route('chapter.update',[$chapter->id])}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{$chapter->tieude}}" name="tieude" onkeyup="ChangeToSlug();" id="slug" aria-describedby="emailHelp" placeholder="Tên chapter...">                           
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Slug chapter</label>
                            <input type="text" class="form-control" value="{{$chapter->tieude}}" name="slug_chapter" id="convert_slug" aria-describedby="emailHelp" placeholder="Slug chapter...">                           
                        </div>
                        {{-- <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="noidung" id="noidung_chapter" class="form-control" row="5" style="resize: none">{{$chapter->noidung}}</textarea>
                        </div>
                        <div class="form-group">
