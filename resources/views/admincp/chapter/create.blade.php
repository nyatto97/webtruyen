                ...
                <div class="card-body">               
                    ...
                    <form method="POST" action="{{route('chapter.store')}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{old('tieude')}}" name="tieude" onkeyup="ChangeToSlug();" id="slug" aria-describedby="emailHelp" placeholder="Tên chapter...">                           
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="noidung" id="noidung_chapter" class="form-control" row="5" style="resize: none"></textarea>
                        </div>
                        <div class="form-group">
