...
class TheloaiController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data = $request->validate(
            ...
            [
                ...
                'slug_theloai.required' => 'Phải có slug thể loại.',
    ...
    public function update(Request $request, $id)
    {
        $data = $request->validate(
            ...
            [
                'tentheloai.required' => 'Phải có thể loại.',
                'slug_tentheloai.required' => 'Phải có slug thể loại.',
                'mota.required' => 'Phải có tóm tắt thể loại.',
